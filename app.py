...
The navigation is a flat list rather than named sections. It used to carry one
group called "Raman & PL", which stopped being true at v4.0.0 when the QC Panel
grew an OM image and Material Presets grew an optical block — and any
technique-based label goes the same way as techniques are added. With four
pages, no label carries more information than the page names already do.
"""
...
plot_explorer_page = st.Page("pages/4_Plot_Explorer.py", title="Plot Explorer", icon="📈")
